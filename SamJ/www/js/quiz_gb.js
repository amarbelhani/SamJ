...
var $indicators = $('<ol>')
  ...
  */
  ...
  var $social = $("<div>")
    ...
    .html('<div id = "social-text">Did you like the quiz? Share your results with your friends, so they can give it a shot!</div><br><br><a class="btn btn-primary" href="index.html"> < Back</a>')
    .appendTo($results_slide);
